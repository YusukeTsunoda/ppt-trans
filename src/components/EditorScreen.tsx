        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-5 mb-6">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">翻訳編集画面</h1>
            </div>
            <div className="flex gap-2">
              <button
                onClick={handleDownload}
                disabled={isSaving}
                className="px-6 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 disabled:bg-slate-400 disabled:cursor-not-allowed flex items-center gap-2 transition-all duration-200 font-medium"
              >
                {isSaving ? (
                  <>
